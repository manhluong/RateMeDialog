...
import com.malubu.wordpress.ratemedialog.R;
...
public class RateMeDialog extends DialogFragment
    ...
    */
   public static final String RATEMEDIALOG_TAG = ("com.malubu.wordpress.ratemedialog.RateMeDialog"+APPTAG);
   ...
   public View onCreateView(LayoutInflater inflater,
      ...
      {
      View v = inflater.inflate(R.layout.ratemedialog, container, false);
      if(_title==null)
